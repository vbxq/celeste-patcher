package gg.celeste.manager.ui.screen.installer
...
import gg.celeste.manager.installer.step.StepStatus
import gg.celeste.manager.ui.viewmodel.installer.InstallerViewModel
import gg.celeste.manager.ui.widgets.dialog.BackWarningDialog
import gg.celeste.manager.ui.widgets.dialog.DownloadFailedDialog
import gg.celeste.manager.ui.widgets.installer.StepGroupCard
...
class InstallerScreen(
    ...
    override fun Content() {
        ...
        val intentListener: (Intent) -> Unit = remember {
            {
                val msg = it.getStringExtra("celeste.extras.EXTRA_MESSAGE")
