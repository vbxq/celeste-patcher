...
class DownloadManager(
    ...
    suspend fun downloadCeleste(out: File, onProgressUpdate: (Float?) -> Unit) =
        download(
            "https://github.com/vbxq/celeste-patcher/releases/latest/download/CelesteXposed.apk",
            out,
            onProgressUpdate
        )
    ...
    suspend fun downloadUpdate(out: File) =
        download(
            "https://github.com/vbxq/celeste-patcher/releases/latest/download/CelesteManager.apk",
            out
        ) {
        }
